...
from shared.patch_object.app import Patch
...
from shared.untested_get_function_definitions import app as get_function_definitions
...
def main(test: Test | dict) -> Test:
  ...
  execute_function_in_thread.main(
