...
class Data(slots=True):
  ...
  cast_as: List[str] | str | None = None
...
class Case:
  ...
  inputs: List[Data] | Data | None = None
  expected_outputs: List[Data] | Data | None = None
  outputs: List[Data] | Data | None = None
  assertions: List[str] | str | None = None


@dataclass
class Test(slots=True):
  module_path: str | None = None
  test_resources_directory_path: str | None = None
  # environment: 
  cases: List[Case] | Case = None
